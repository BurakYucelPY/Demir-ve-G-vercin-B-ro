          ...
          <div className="text-center">
            <div className="grid grid-cols-1 gap-8">
              {stats.map((stat) => (
                                 <div 
                   key={stat.id} 
                   className="scroll-animate delay-300 mx-auto flex max-w-4xl flex-col gap-y-4"
                 >
                                     <dt className="scroll-animate delay-400 text-4xl font-bold leading-7 text-blue-900 sm:text-5xl">
                     {stat.value}
                   </dt>
                  <dd className="scroll-animate delay-600 text-lg leading-7 text-gray-600 font-medium">
                    {stat.name}
                  </dd>
                </div>
              ))}
