...
export default function ProjectTypes() {
  return (
    <div id="project-types" className="bg-gray-900 py-24 sm:py-32 overflow-hidden relative">
      ...
      <div className="absolute inset-0">
        ...
        />
        <motion.div 
          className="absolute top-3/4 right-1/4 w-1 h-1 bg-purple-500/40 rounded-full"
          animate={{ 
            opacity: [0.4, 0.9, 0.4],
            scale: [1, 1.5, 1]
          }}
        ...
        />
        <motion.div 
          className="absolute top-1/2 left-3/4 w-1.5 h-1.5 bg-indigo-500/25 rounded-full"
          animate={{ 
